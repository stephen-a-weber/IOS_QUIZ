...
//        }
     ...
     ////   let path = ////Bundle.main.resourcePath?.appending("/IOS_QUIZ/IOS_QUIZ/IOS.sqlite")
        let databaseName = nameOfDB.text!+".sqlite"
        var fileP = try! FileManager.default.url(for: .documentDirectory, in: .userDomainMask, appropriateFor: nil, create: false).appendingPathComponent(databaseName)
  //      let url = URL(string: "/IOS_QUIZ/IOS_QUIZ/IOS.sqlite")!
